		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-4">
					...
					<div class="row">
					@php
				$artikel = \App\Artikel::with('tag', 'kategori', 'user')->get();
				@endphp
				@foreach($artikel as $artikell)
					<div class="mb-30 p-30 card-view">
						...
						<div class="sided-80x mb-20">
							<div class="s-left">
								<img src="/assets/img/artikel" alt="">
							</div><!-- s-left -->
							<div class="blog-text">
							<h3><a href="#">{{$artikell->judul}}</a></h3>
                            <h3><a href="#">{{$artikell->kategori->nama_kategori}}</a></h3>
						</div>
							<div class="s-right">
								<h5><a href="#">
